...
import { ActionName, GLTFActions, GLTFResult } from "./Drone.types";

export default function DroneModel(props: JSX.IntrinsicElements["group"]) {
  ...
  useEffect(() => {
    // if (actions?.hover && actions?.hover instanceof THREE.AnimationClip)
    actions?.hover?.play();
  }, [actions]);
  return (
